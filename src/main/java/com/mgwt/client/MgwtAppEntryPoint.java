...
public class MgwtAppEntryPoint implements EntryPoint {
    ...
    MGWT.applySettings(MGWTSettings.getAppSetting());
		...
		historyHandler.register(clientFactory.getPlaceController(), clientFactory.getEventBus(), new com.mgwt.client.activities.HomePlace());
...
//
		display.setFirstWidget(new InlineHyperlink("sdgsdg","sdf"));
		//
...
//		mainContainer.setWidget(mainDisplay);
		mainContainer.setWidget(button);
